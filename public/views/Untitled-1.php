                ...
                <form action="../models/script_php/ajout.php?action=msg-acc" method="post" class="row justify-content-center">
                    ...
                    <div class="col-11 text-center">
                        <div class="form-floating my-4">
                            <textarea class="form-control cadre_bois" id="msg_accueil" name="msg_accueil" row="20" style="height: 13rem"><?= $msg_accueil ?></textarea>
                            <label for="msg_accueil" class="text-info fw-bold text-decoration-underline">Entrez votre message d'accueil:</label>
                        </div>
                    </div>
                    <div class="col-11 row cadre_noir bg-biere">
                        <div class="form-floating my-4 border border-dark border-5
                                    col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            ...
                            <label for="para_accueil_un" class="text-info fw-bold text-decoration-underline">Entrez votre premier paragraphe:</label>
                        </div>
                        <div class="form-floating my-4 border border-dark border-5
                                    col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <!-- Ajouter un champ de texte pour afficher le message d'accueil -->
                            ...
                            <label for="para_accueil_deux" class="text-info fw-bold text-decoration-underline">Entrez votre deuxième paragraphe:</label>
                        </div>
                        <div class="form-floating my-4 border border-dark border-5
                                    col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <!-- Ajouter un champ de texte pour afficher le message d'accueil -->
                            ...
                            <label for="para_accueil_trois" class="text-info fw-bold text-decoration-underline">Entrez votre troisième paragraphe:</label>
                        </div>
                        <div class="form-floating my-4 border border-dark border-5
                                    col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <!-- Ajouter un champ de texte pour afficher le message d'accueil -->
                            ...
                            <label for="para_accueil_quatre" class="text-info fw-bold text-decoration-underline">Entrez votre quatrième paragraphe:</label>
                        </div>
                    </div>
